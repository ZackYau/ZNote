package com.example.zack.znote.widget;
...
public class LabelsLayout extends ViewGroup {
    ...
    public LabelsLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray attrArray = context.obtainStyledAttributes(attrs, R.styleable.LabelsLayout);
        if (attrArray != null) {
            childHorizontalSpace = attrArray.getDimensionPixelSize(R.styleable.LabelsLayout_labelHorizontalSpace, 0);
            childVerticalSpace = attrArray.getDimensionPixelSize(R.styleable.LabelsLayout_labelVerticalSpace, 0);
            attrArray.recycle();
        }
    }
